...
• ${text}`
    ...
    m.reply(`${emoji} El reporte se envío a mi creador, cualquier informe falso seras baneado ojo si es para reportar un número de WhatsApp el creador se comunica con tigo.`)
}
